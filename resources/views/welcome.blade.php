            ...
            <div class="row core-values">
                ...
                <div class="col-lg-3 col-sm-6 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1200"
                    ...
                    <div class="single-features-card">
                        ...
                        <h3>Collaboration</h3>
                        <p>We believe in working together with our partners and communities to co-create solutions that
                            address local needs and challenges.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1200"
                    data-aos-delay="600">
                    <div class="single-features-card">
                        ...
                        <p>We believe in creating a safe and inclusive space for all young people, regardless of their
                            background or identity. </p>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1200"
                    data-aos-delay="800">
                    <div class="single-features-card">
                        ...
                        <h3>Empowerment</h3>
                        <p>We believe in empowering young people to take ownership of their ideas and projects, and to
                            be leaders in their communities. </p>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1200"
                    data-aos-delay="800">
                    <div class="single-features-card">
                        ...
                        <p>We believe in using resources responsibly and ensuring that our programs have a positive
                            impact on the environment and the community.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1200"
                    data-aos-delay="800">
                    <div class="single-features-card">
                        ...
                        <h3>Innovation</h3>
                        <p>We believe in the creative and innovative potentials of young people to finding simple
                            solutions to very complex problems and to power the change needed in their communities. </p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="owl-item cloned" style="width: 422.75px; margin-right: 20px;">
                                <div class="single-trailer-card">
                                    <div class="trailer-img">
                                        <img src="{{ asset('/storage/' . $movie->cover) }}" alt="Image">
                                        <div class="play-btn">
                                            <a class="popup-youtube" href="{{ $movie->video_url }}">
